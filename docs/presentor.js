...
;// CONCATENATED MODULE: ./src/javascript/config.js
var firebaseConfig = {
  apiKey: 'AIzaSyBKuRo4xkTbRAjt1u10QW2HSe1-18oNFc4',
  authDomain: 'signal2023-bbb18.firebaseapp.com',
  databaseURL: 'https://signal2023-bbb18-default-rtdb.europe-west1.firebasedatabase.app',
  databaseName: 'slides',
  projectId: 'signal2023-bbb18',
  storageBucket: 'signal2023-bbb18.appspot.com',
  messagingSenderId: '731850821630',
  appId: '1:731850821630:web:97e98e2bc55f6afdb97aaf',
  measurementId: 'G-B4ZNL3746H'
};
...
;// CONCATENATED MODULE: ./src/javascript/slides_data.js

var token = 'pate7m4elKou9i2Gq.509fe0e89292986b4bfb83b298003a7414e1ea9c51ca041b270a851b4b193df0';
airtable_umd_default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable_umd_default().base('apprEyigq68R4l6Pz'); // function getSlides() {
//   return new Promise((resolve, reject) => {
//     const content = []
//     base('Post Teasers')
...
;// CONCATENATED MODULE: ./src/javascript/basics.js
function addSlides(slides) {
  return new Promise(function (resolve, reject) {
    slides.forEach(function (slide, index) {
      var section = document.createElement('section');
      section.classList.add('slide');
      section.classList.add("slide".concat(slide.place));
      section.style.display = 'none';
      var text = document.createElement(slide.type);
...
;// CONCATENATED MODULE: ./src/presentor.js
...
function writeTouchData(slide) {
  var slidesListRef = ref(db, firebaseConfig.databaseName);
  var newSlideRef = push(slidesListRef);
  set(newSlideRef, {
    slide: slide
  });
}
